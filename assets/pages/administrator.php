<?php   echo '
        ...
        <div class="col-span-12 xl:col-span-4">
            <div class="card">
              ...
              <div class="card-body">
                <div class="flex items-center justify-between gap-3 flex-wrap">
                  <h3 class="font-light flex items-center mb-0">
                    <i class="feather icon-arrow-up text-success-500 text-[30px] mr-1.5"></i> $8.638.32
                  </h3>
                  <p class="mb-0">80%</p>
                </div>
                <div class="w-full bg-theme-bodybg rounded-lg h-1.5 mt-6 dark:bg-themedark-bodybg">
        ...
        <div class="col-span-12 xl:col-span-8 md:col-span-6">
            <div class="card">
              ...
              <div class="card-body">
                <div id="world-low" class="set-map" style="height: 450px"></div>
              </div>
            </div>
          </div>
          <div class="col-span-12 xl:col-span-4 md:col-span-6">
            <div class="card bg-primary-500 mb-4">
              <div class="card-header !border-b-0">
                <h5 class="text-white">Earnings</h5>
              </div>
              <div class="card-body" style="padding: 0 25px">
                <div class="earning-text mb-4">
                  <h3 class="mb-3 text-white font-light">$ 4295.36 <i class="feather icon-arrow-up teal accent-3"></i>
                  </h3>
                  <span class="uppercase text-white block">Total Earnings</span>
                </div>
            ...
            <div class="card">
              <div class="card-body border-b border-theme-border dark:border-themedark-border">
                <div class="flex items-center gap-6">
                  <div class="shrink-0">
                    <i class="feather icon-zap text-[30px] text-success-500"></i>
                  </div>
                  <div class="grow">
                    <h3 class="font-light">235</h3>
                    <span class="block uppercase">total ideas</span>
                  </div>
                </div>
              </div>
              <div class="card-body">
                <div class="flex items-center gap-6">
                  <div class="shrink-0">
                    <i class="feather icon-map-pin text-[30px] text-primary-500"></i>
                  </div>
                  <div class="grow">
                    <h3 class="font-light">26</h3>
                    <span class="block uppercase">total locations</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card card-social">
              ...
              <div class="card-body">
                <div class="grid grid-cols-12 gap-x-6">
                  ...
                  <div class="col-span-6">
                    <h6 class="text-center mb-2.5">
                      <span class="text-muted m-r-5">Duration:</span>350
                    </h6>
                    <div class="w-full bg-theme-bodybg rounded-lg h-1.5 dark:bg-themedark-bodybg">
            ...
            <div class="card card-social">
              ...
              <div class="card-body">
                <div class="grid grid-cols-12 gap-x-6">
                  ...
                  <div class="col-span-6">
                    <h6 class="text-center mb-2.5">
                      <span class="text-muted m-r-5">Duration:</span>800
                    </h6>
                    <div class="w-full bg-theme-bodybg rounded-lg h-1.5 dark:bg-themedark-bodybg">
            ...
            <div class="card card-social">
              ...
              <div class="card-body">
                <div class="grid grid-cols-12 gap-x-6">
                  ...
                  <div class="col-span-6">
                    <h6 class="text-center mb-2.5">
                      <span class="text-muted m-r-5">Duration:</span>900
                    </h6>
                    <div class="w-full bg-theme-bodybg rounded-lg h-1.5 dark:bg-themedark-bodybg">
            ...
            <div class="card user-list">
              ...
              <div class="card-body">
                <div class="flex items-center justify-between gap-1 mb-5">
                  <h2 class="font-light flex items-center m-0">4.7 <i class="fas fa-star text-[10px] ml-2.5 text-warning-500"></i>
                  </h2>
                  <h6 class="flex items-center m-0">0.4 <i class="fas fa-caret-up text-success text-[22px] ml-2.5"></i>
                  </h6>
                </div>
                <div class="flex items-center justify-between gap-2 mb-2">
                  <h6 class="flex items-center gap-1">
                    <i class="fas fa-star text-[10px] mr-2.5 text-warning-500"></i> 5
                  </h6>
                  <h6>384</h6>
                </div>
                ...
                <div class="flex items-center justify-between gap-2 mb-2">
                  <h6 class="flex items-center gap-1">
                    <i class="fas fa-star text-[10px] mr-2.5 text-warning-500"></i> 4
                  </h6>
                  <h6>145</h6>
                </div>
                <div class="w-full bg-theme-bodybg rounded-lg h-1.5 mb-6 mt-3 dark:bg-themedark-bodybg">
                ...
                <div class="flex items-center justify-between gap-2 mb-2">
                  <h6 class="flex items-center gap-1">
                    <i class="fas fa-star text-[10px] mr-2.5 text-warning-500"></i> 3
                  </h6>
                  <h6>24</h6>
                </div>
                <div class="w-full bg-theme-bodybg rounded-lg h-1.5 mb-6 mt-3 dark:bg-themedark-bodybg">
                ...
                <div class="flex items-center justify-between gap-2 mb-2">
                  <h6 class="flex items-center gap-1">
                    <i class="fas fa-star text-[10px] mr-2.5 text-warning-500"></i> 2
                  </h6>
                  <h6>1</h6>
                </div>
                <div class="w-full bg-theme-bodybg rounded-lg h-1.5 mb-6 mt-3 dark:bg-themedark-bodybg">
                ...
                <div class="flex items-center justify-between gap-2 mb-2">
                  <h6 class="flex items-center gap-1">
                    <i class="fas fa-star text-[10px] mr-2.5 text-warning-500"></i> 1
                  </h6>
                  <h6>0</h6>
                </div>
                  ...
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        ...
                        <td>
                          <h6 class="text-muted">
                            <i class="fas fa-circle text-success text-[10px] ltr:mr-4 rtl:ml-4"></i> 11 MAY 12:56
                          </h6>
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        ...
                        <td>
                          <h6 class="text-muted">
                            <i class="fas fa-circle text-danger text-[10px] ltr:mr-4 rtl:ml-4"></i> 11 MAY 10:35
                          </h6>
                        </td>
                        <td>
                          <a href="#!" class="badge bg-theme-bg-2 text-white text-[12px] mx-2">Reject</a>
                      ...
                      <tr class="unread">
                        ...
                        <td>
                          <h6 class="text-muted">
                            <i class="fas fa-circle text-success text-[10px] ltr:mr-4 rtl:ml-4"></i> 9 MAY 17:38
                          </h6>
                        </td>
                        <td>
                          <a href="#!" class="badge bg-theme-bg-2 text-white text-[12px] mx-2">Reject</a>
                      ...
                      <tr class="unread">
                        ...
                        <td>
                          <h6 class="text-muted f-w-300">
                            <i class="fas fa-circle text-danger text-[10px] ltr:mr-4 rtl:ml-4"></i> 19 MAY 12:56
                          </h6>
                        </td>
                        <td>
                          <a href="#!" class="badge bg-theme-bg-2 text-white text-[12px] mx-2">Reject</a>
                      ...
                      <tr class="unread">
                        ...
                        <td>
                          <h6 class="text-muted">
                            <i class="fas fa-circle text-success text-[10px] ltr:mr-4 rtl:ml-4"></i> 21 July 12:56
                          </h6>
                        </td>
                        <td>
                          <a href="#!" class="badge bg-theme-bg-2 text-white text-[12px] mx-2">Reject</a>
