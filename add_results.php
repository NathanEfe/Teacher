...
$students = [];
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['class_id'], $_GET['session'], $_GET['term'])) {
    $class = $_GET['class_id'];
    ...
    <div class="card-header bg-success text-white">Download Template</div>
      <div class="card-body">
        <p class="text-muted text-danger mb-4">
            ...
            <strong><?php echo $className . ' (' . $term . ' Term, ' . $session_year . ')'; ?></strong>. 
            All subjects for this class will be included.
        </p>
